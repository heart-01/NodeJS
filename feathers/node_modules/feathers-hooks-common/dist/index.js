...
__export(src_exports, {
  actOnDefault: () => actOnDefault,
  actOnDispatch: () => actOnDispatch,
  alterItems: () => alterItems,
  cache: () => cache,
  callingParams: () => callingParams,
  callingParamsDefaults: () => callingParamsDefaults,
  checkContext: () => checkContext,
  checkContextIf: () => checkContextIf,
  combine: () => combine,
  ...
  keep: () => keep,
  keepInArray: () => keepInArray,
  keepQuery: () => keepQuery,
  keepQueryInArray: () => keepQueryInArray,
  lowerCase: () => lowerCase,
  makeCallingParams: () => makeCallingParams,
  mongoKeys: () => mongoKeys,
  ...
  sequelizeConvert: () => sequelizeConvert,
  serialize: () => serialize,
  setField: () => setField,
  setNow: () => setNow,
  setSlug: () => setSlug,
...
var { processHooks } = import_commons.hooks;
...
var import_errors = __toESM(require("@feathersjs/errors"));

// src/common/pluck.ts
var import_pick = __toESM(require("lodash/pick"));
function pluck(items, fieldNames) {
  if (!Array.isArray(items)) {
    return (0, import_pick.default)(items, fieldNames);
  }
  const pluckedItems = (Array.isArray(items) ? items : [items]).map((item) => (0, import_pick.default)(item, fieldNames));
  return pluckedItems;
}
...
function setFields(items, fieldValue, fieldNames, defaultFieldName) {
  ...
  (Array.isArray(items) ? items : [items]).forEach((item) => {
    fieldNames.forEach((fieldName) => {
      (0, import_set.default)(item, fieldName, value);
    });
  });
}
...
function transformItems(items, fieldNames, transformer) {
  (Array.isArray(items) ? items : [items]).forEach((item) => {
    fieldNames.forEach((fieldName) => {
      transformer(item, fieldName, (0, import_get.default)(item, fieldName));
    });
  });
}
...
function traverse(items, converter) {
  (Array.isArray(items) ? items : [items]).forEach((item) => {
    (0, import_traverse.default)(item).forEach(converter);
  });
}
...
// src/hooks/alter-items.ts
var { BadRequest } = import_errors.default;
...
function dePopulate(func) {
  return (context) => {
    ...
    const converter = (item) => {
      ...
      return (0, import_omit.default)(item, keys.concat(_computed).concat(_include));
    };
...
var import_errors2 = __toESM(require("@feathersjs/errors"));
var { MethodNotAllowed } = import_errors2.default;
...
function discard(...fieldNames) {
  return (context) => {
    ...
    const items = getItems(context);
    const convert = (item) => (0, import_omit2.default)(item, fieldNames);
...
function discardQuery(...fieldNames) {
  return (context) => {
    ...
    const query = (context.params || {}).query || {};
    context.params.query = (0, import_omit3.default)(query, fieldNames);
    return context;
  };
}
...
var debug2 = (0, import_debug.default)("fgraphql");
...
var import_errors3 = __toESM(require("@feathersjs/errors"));
var { MethodNotAllowed: MethodNotAllowed2 } = import_errors3.default;
...
function replaceItem(item, fields) {
  ...
  fields.forEach((field) => {
    if (!(0, import_has.default)(item, field))
      return;
    const value = (0, import_get2.default)(item, field);
    (0, import_set2.default)(newItem, field, value);
  });
  item = newItem;
  return item;
}
...
var import_errors4 = __toESM(require("@feathersjs/errors"));
...
var { BadRequest: BadRequest2 } = import_errors4.default;
...
function replaceIn(item, field, fieldNames) {
  const target = (0, import_get3.default)(item, field);
  if (target) {
    if (!Array.isArray(target))
      throw new BadRequest2(`The 'field' param must lead to array. found type '${typeof target}' instead`);
    (0, import_set3.default)(item, field, target.map((item2) => replaceItem2(item2, fieldNames)));
  }
}
function replaceItem2(item, fields) {
  ...
  const newItem = {};
  fields.forEach((field) => {
    if (!(0, import_has2.default)(item, field))
      return;
    const value = (0, import_get3.default)(item, field);
    (0, import_set3.default)(newItem, field, value);
  });
  item = newItem;
  return item;
}
...
var import_errors5 = __toESM(require("@feathersjs/errors"));
...
var { BadRequest: BadRequest3 } = import_errors5.default;
...
function replaceIn2(item, field, fieldNames) {
  const target = (0, import_get4.default)(item, field);
  if (target) {
    if (!Array.isArray(target))
      throw new BadRequest3(`The 'field' param must lead to array. found type '${typeof target}' instead`);
    (0, import_set4.default)(item, field, target.map((item2) => replaceItem3(item2, fieldNames)));
  }
}
function replaceItem3(item, fields) {
  ...
  const newItem = {};
  fields.forEach((field) => {
    if (!(0, import_has3.default)(item, field))
      return;
    const value = (0, import_get4.default)(item, field);
    (0, import_set4.default)(newItem, field, value);
  });
  item = newItem;
  return item;
}
...
var import_set5 = __toESM(require("lodash/set"));
var import_errors6 = __toESM(require("@feathersjs/errors"));
var { BadRequest: BadRequest4 } = import_errors6.default;
  ...
  return (context) => {
    ...
    transformItems(getItems(context), fieldNames, (item, fieldName, value) => {
      if (value !== void 0) {
        ...
        (0, import_set5.default)(item, fieldName, value ? value.toLowerCase() : value);
      }
    });
    return context;
  };
...
var import_traverse3 = __toESM(require("traverse"));
function mongoKeys(ObjectId, keyFields) {
  ...
  return (context) => {
    ...
    const query = context.params.query || {};
    (0, import_traverse3.default)(query).forEach(function(node) {
...
var import_set6 = __toESM(require("lodash/set"));
var import_errors7 = __toESM(require("@feathersjs/errors"));
var { BadRequest: BadRequest5 } = import_errors7.default;
...
function populateItem(options, context, item, includeSchema, depth) {
  ...
  return Promise.all(include.map((childSchema) => {
    ...
    if (!query && !select && (!parentField || (0, import_get5.default)(item, parentField) === void 0)) {
      return void 0;
    }
    ...
    children.forEach((child) => {
      if (child) {
        (0, import_set6.default)(item, child.nameAs, child.items);
      }
    });
    return item;
  });
...
function populateAddChild(options, context, parentItem, childSchema, depth) {
  ...
  return Promise.resolve().then(() => select ? select(context, parentItem, depth) : {}).then((selectQuery) => {
    let sqlQuery = {};
    if (parentField) {
      const parentVal = (0, import_get5.default)(parentItem, parentField);
...
var import_has4 = __toESM(require("lodash/has"));
var import_omit4 = __toESM(require("lodash/omit"));
var import_errors8 = __toESM(require("@feathersjs/errors"));
var { BadRequest: BadRequest6 } = import_errors8.default;
function preventChanges(ifThrow, ...fieldNames) {
  ...
  return (context) => {
    ...
    const { data } = context;
    fieldNames.forEach((name) => {
      if ((0, import_has4.default)(data, name)) {
        if (ifThrow) {
          throw new BadRequest6(`Field ${name} may not be patched. (preventChanges)`);
        }
        context.data = (0, import_omit4.default)(data, name);
      }
    });
    return context;
  };
...
var import_errors9 = __toESM(require("@feathersjs/errors"));
var import_has5 = __toESM(require("lodash/has"));
var { BadRequest: BadRequest7 } = import_errors9.default;
function required(...fieldNames) {
  return (context) => {
    ...
    (Array.isArray(items) ? items : [items]).forEach((item) => {
      fieldNames.forEach((name) => {
        if (!(0, import_has5.default)(item, name))
          throw new BadRequest7(`Field ${name} does not exist. (required)`);
        const value = (0, import_get6.default)(item, name);
...
var import_errors10 = __toESM(require("@feathersjs/errors"));
var { BadRequest: BadRequest8 } = import_errors10.default;
...
var import_set7 = __toESM(require("lodash/set"));
    ...
    function serializeItem(item, schema2) {
      ...
      if (only) {
        ...
        only.concat("_include", "_elapsed", item._include || []).forEach((key) => {
          const value = (0, import_get7.default)(item, key);
          if (value !== void 0) {
            (0, import_set7.default)(newItem, key, value);
          }
        });
        item = newItem;
      }
      ...
      if (exclude) {
        item = (0, import_omit5.default)(item, exclude);
      }
...
var import_errors11 = __toESM(require("@feathersjs/errors"));
var { Forbidden } = import_errors11.default;
var debug3 = (0, import_debug2.default)("feathers-hooks-common/setField");
function setField({ as, from, allowUndefined = false }) {
  ...
  return (context) => {
    ...
    const value = (0, import_get8.default)(context, from);
    if (value === void 0) {
    ...
    return (0, import_setWith.default)(context, as, value, import_clone.default);
  };
}

// src/hooks/set-now.ts
var import_errors12 = __toESM(require("@feathersjs/errors"));
var { BadRequest: BadRequest9 } = import_errors12.default;
...
var import_set8 = __toESM(require("lodash/set"));
var import_errors13 = __toESM(require("@feathersjs/errors"));
var { GeneralError } = import_errors13.default;
  ...
  return (context) => {
    ...
    if (context.params && context.params.provider === "rest") {
      ...
      if (typeof value === "string" && value[0] !== ":") {
        (0, import_set8.default)(context.params, fieldName, value);
      }
    }
  };
}
...
// src/hooks/sifter.ts
var import_errors14 = __toESM(require("@feathersjs/errors"));
var { BadRequest: BadRequest10 } = import_errors14.default;
...
var import_errors15 = __toESM(require("@feathersjs/errors"));
var { GeneralError: GeneralError2 } = import_errors15.default;
...
var import_errors16 = __toESM(require("@feathersjs/errors"));
var { BadRequest: BadRequest11 } = import_errors16.default;
...
var import_errors17 = __toESM(require("@feathersjs/errors"));
var { BadRequest: BadRequest12 } = import_errors17.default;
...
var import_errors18 = __toESM(require("@feathersjs/errors"));
var { BadRequest: BadRequest13 } = import_errors18.default;
...
var import_set9 = __toESM(require("lodash/set"));
...
function callingParams({
  ...
  return (context) => {
    ...
    allPropNames.forEach((name) => {
      if (name) {
        const value = (0, import_get9.default)(context.params, name);
        if (value !== void 0) {
          (0, import_set9.default)(newParams, name, value);
        }
      }
    });
...
// src/utils/is-not.ts
var import_errors19 = __toESM(require("@feathersjs/errors"));
var { MethodNotAllowed: MethodNotAllowed3 } = import_errors19.default;
