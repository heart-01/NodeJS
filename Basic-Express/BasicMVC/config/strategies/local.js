...
// config instance local strategy เพื่อให้ passport เอาไปใช้งานแล้วก็บอกวิธีว่าเราจะทำการตรวจสอบ username หรือ password ยังไงจากด้านล่างจะใช้ mongoose เช็ค username ว่ามีไหมถ้าไม่มีก็จะ return error
passport.use(
